...
class TestUserCollectorTransform:
    ...
    async def test_team_discovery(self):
        ...
        raw_data = [
            {"type": "user", "id": "u1", "user_name": "alice@co.com", "display_name": "Alice", "active": True, "groups": ["de"]},
            {"type": "user", "id": "u2", "user_name": "bob@co.com", "display_name": "Bob", "active": True, "groups": ["de"]},
            {"type": "group", "id": "g1", "display_name": "de", "members": [{"id": "u1", "display": "Alice"}, {"id": "u2", "display": "Bob"}]},
        ]
