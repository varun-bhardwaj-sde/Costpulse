...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("dbu_count", sa.Numeric(18, 6), nullable=False, server_default="0"),
        sa.Column("dbu_rate", sa.Numeric(18, 6), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("dbu_cost", sa.Numeric(18, 6), nullable=False, server_default="0"),
        sa.Column("compute_cost", sa.Numeric(18, 6), nullable=False, server_default="0"),
        sa.Column("storage_cost", sa.Numeric(18, 6), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("total_dbu_consumed", sa.Numeric(18, 6), server_default="0"),
        sa.Column("total_cost_usd", sa.Numeric(18, 6), server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("dbu_consumed", sa.Numeric(18, 6), server_default="0"),
        sa.Column("cost_usd", sa.Numeric(18, 6), server_default="0"),
        sa.Column("num_tasks", sa.Integer, server_default="1"),
        sa.Column("tags", postgresql.JSONB, server_default="{}"),
        sa.Column("schedule", sa.String(255)),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.UniqueConstraint("workspace_id", "run_id", name="uq_job_runs_workspace_run"),
    )
    ...
    op.create_table(
        ...
        sa.Column("current_cost", sa.Numeric(18, 6)),
        sa.Column("estimated_savings", sa.Numeric(18, 6)),
